...
@Autonomous (name = "PUSH_Red_Auto", group = "autos")
public class Red_Auto_Push extends LinearOpMode
{    private static final boolean USE_WEBCAM = true;  // true for webcam, false for phone camera
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(new Pose2d(-37.97, -61.48, Math.toRadians(90.00)))
                ...
                .lineToLinearHeading(new Pose2d(-35.98, -34.04, Math.toRadians(30.00)))
